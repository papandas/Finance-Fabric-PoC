...
function printHelp ()
{
    ...
    echo -e "${GREEN}-n ${RESET}defaults to ${GREEN}finance-network${RESET}. use ${YELLOW}-n your-named-network ${RESET}if you are using a different network name"  | indent
...
{
    echo ""
    echo -e "${YELLOW}archive creation script for the Finance Network Series" | indent
